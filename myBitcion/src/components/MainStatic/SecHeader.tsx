...
const SecHeader = () => {
  ...
  return (
    <div className="h-[50px] border-b mt-20 w-full flex justify-center items-center z-10 fixed top-0 left-0 right-0 bg-white ">
      <div className="w-full relative flex justify-between items-center">
        ...
        <div className="flex items-center mr-16 min-md:block">
          <div className=" hidden md:flex mr-5">
            <MdForwardToInbox className="mr-4" cursor="pointer" size={20} />
