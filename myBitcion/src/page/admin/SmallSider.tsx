import { FaAmazonPay, FaWallet } from "react-icons/fa";
import {
  MdDashboard,
        ...
        <div className="w-16 h-16 object-cover flex border rounded-full items-center justify-center">
          <img
            ...
            src={
              data?.avatar
                ? data?.avatar
                : "https://img.freepik.com/free-psd/3d-render-avatar-character_23-2150611704.jpg?w=1380&t=st=1724609221~exp=1724609821~hmac=c5445ba0a790922e5b571fa3ea98f619f88a4077b458c680775f3eb5797ef609"
            }
            alt="Admin Avatar"
          />
        </div>
